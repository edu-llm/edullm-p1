...
worked WinoGrande/BoolQ examples). Its OUTPUT, `eval_items.jsonl.gz`, is
committed in this directory precisely so that everything downstream
(`build_item_index.py`, `scan_corpus.py`, `aggregate_by_domain.py`) is
runnable with the stdlib alone, without ai2-olmo, from that committed file.
